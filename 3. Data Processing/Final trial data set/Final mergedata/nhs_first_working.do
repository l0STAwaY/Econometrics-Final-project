...
// we can use mi estimate, or post: ologit impute_dvint impute_earnings, robust to transform to odds ratio but marginal effect is going to that anyways
// previous population regression function
// model7 attempts another interaction term not specified in the population model but as expected 

eststo clear

mi estimate,post : ologit impute_dvint impute_earnings
eststo model1

mi estimate,post: ologit impute_dvint impute_earnings impute_health 
eststo model2

mi estimate,post: ologit impute_dvint impute_earnings impute_health  i.impute_earnings#i.impute_health
eststo model7

mi estimate,post: ologit impute_dvint impute_earnings impute_health 

mi estimate, post: ologit impute_dvint impute_earnings impute_health sex
eststo model3

mi estimate, post: ologit impute_dvint impute_earnings impute_health age sex
eststo model4

mi estimate, post: ologit impute_dvint impute_earnings impute_health age sex racenew
eststo model5

mi estimate, post: ologit impute_dvint impute_earnings impute_health age sex racenew age_dummy impute_mcareprob impute_mcareprob_dummy
eststo model6

esttab model1 model2 model3 model4 model5 model6 model7 using mi_ologit_dummy_table.rtf, replace



// current population regression function

eststo clear


mi estimate, post: ologit impute_dvint impute_earnings if age < 65
eststo model1

mi estimate, post: ologit impute_dvint impute_earnings impute_health if age < 65
eststo model2

mi estimate, post: ologit impute_dvint impute_earnings impute_health sex if age < 65
eststo model3

mi estimate, post: ologit impute_dvint impute_earnings impute_health age sex if age < 65
eststo model4

mi estimate, post: ologit impute_dvint impute_earnings impute_health age sex racenew if age < 65
eststo model5
...
foreach outcome in 100 203 204 302 305 400 {
    ...
    * Now, run the ologit model for _mi_m==0 (non-missing data) to compute margins
    quietly ologit impute_dvint impute_earnings impute_health age sex racenew if age < 65 if _mi_m == 0
...
ologit impute_dvint impute_wormedbill impute_health age sex racenew i.year if age < 65
